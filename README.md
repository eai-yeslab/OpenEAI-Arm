...
---
 [OpenEAI-Arm]([https://github.com/eai-yeslab/OpenEAI_Arm/asserts/Overall](https://github.com/eai-yeslab/OpenEAI-Arm/blob/main/asserts/images/openEAI-platform.pdf))
## 1. Introduction
